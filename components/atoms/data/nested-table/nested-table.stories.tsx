...
import { NestedTable, NestedTableData, ApprovalStatus, NestedTableProps } from "./nested-table";
...
export const Default: StoryObj<NestedTableProps<Department>> = {
    args: {
        data: departmentData,
        columns,
        maxLevel: 4,
...
export const WithApproval: StoryObj<NestedTableProps<Department>> = {
    render: () => {
...
export const MaxLevel2: StoryObj<NestedTableProps<Department>> = {
    args: {
        data: departmentData,
        columns,
        maxLevel: 2,
...
export const ProjectTracking: StoryObj<NestedTableProps<Project>> = {
    render: () => {
...
export const OrderManagement: StoryObj<NestedTableProps<Order>> = {
    render: () => {
